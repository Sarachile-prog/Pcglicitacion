...
import { Search, Filter, MapPin, Building2, Clock, DollarSign, LayoutGrid, List } from "lucide-react"
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">Encuentra y filtra oportunidades de negocio en el sector público.</p>
        </div>
