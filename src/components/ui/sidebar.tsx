      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetTitle className="sr-only">Navegación Licitaciones Globales</SheetTitle>
            <SheetDescription className="sr-only">Menú principal de acceso a licitaciones, tendencias e información del estado.</SheetDescription>
